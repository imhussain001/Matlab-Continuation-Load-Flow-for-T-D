...
load('windfarm_with_boost_inverter.mat', 'P_total', 'Q_total'); 

%% Convert PV power to per-unit
base_MVA = 100e6;  
P_pv_pu = P_total / base_MVA;  
Q_pv_pu = Q_total / base_MVA;
...
fprintf('Wind System added at Bus 33: P = %.2f W, Q = %.2f VAR\n',  P_total/1e6 ,Q_total/1e6 );
