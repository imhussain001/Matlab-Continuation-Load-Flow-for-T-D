...
S_gen_elec = P_gen_elec / pf; % Apparent power (VA)
Q_gen_elec = sqrt(S_gen_elec^2 - P_gen_elec^2); % Reactive power (VAR)
...
P_target = 2.5e6;   % Active Power Required (W) - 2.5 MW
Q_target = 2.2e6;   % Reactive Power Required (VAR) - 2.2 MVAR
