...
%% **Step 3: Integrate PV at Bus 14**
%P_pv = 120e6;   % Wind Active Power (W)
%Q_pv = 40e6;    % Wind Reactive Power (VAR)
S_base = 100e6; % System Base Power

P_pu = P_total / S_base;
Q_pu = Q_total / S_base;

% Adjust BusData: reduce the load at Bus 14 by the Wind generation
BusData(14,7) = BusData(14,7) - P_pu; % Adjust real power demand
BusData(14,8) = BusData(14,8) - Q_pu; % Adjust reactive power demand

fprintf('Wind Turbine system System added at Bus 3: P = %.2f MW, Q = %.2f MVAR\n', P_total/1e6 ,Q_total/1e6 );
