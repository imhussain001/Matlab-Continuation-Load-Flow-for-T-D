...
%P_pv = 120e6;   % PV Active Power (W)
%Q_pv = 40e6;    % PV Reactive Power (VAR)
S_base = 100e6; % System Base Power

P_pu = P_pv / S_base;
Q_pu = Q_pv / S_base;

% Adjust BusData: reduce the load at Bus 14 by the PV generation
BusData(14,7) = BusData(14,7) - P_pu; % Adjust real power demand
BusData(14,8) = BusData(14,8) - Q_pu; % Adjust reactive power demand

fprintf('PV System added at Bus 3: P = %.2f MW, Q = %.2f MVAR\n', P_pv, Q_pv);
